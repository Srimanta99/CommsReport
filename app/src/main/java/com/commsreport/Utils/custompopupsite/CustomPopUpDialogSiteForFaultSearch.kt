...
class CustomPopUpDialogSiteForFaultSearch(context: HomeActivity?, val siteList: List<SiteListModel.RowList>?, val faultFragment: FaultFragment) : Dialog(context!!) {
    ...
    private fun filter(text: String) {
        ...
        faultFragment.siteList=filterdNames

...
class CustomPopUpDialogSiteList(context: HomeActivity?, val siteList: List<SiteListModel.RowList>?,val faultReport: ReportFaultFragment) : Dialog(context!!) {
    ...
    private fun filter(text: String) {
        ...
        faultReport.siteList=filterdNames

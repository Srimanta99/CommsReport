...
data class SiteListModel(val status:Boolean,val message:String,val total_fault:Int,val user_add:Boolean,val row :ArrayList<RowList>) {
    ...
    val site_email:String,val site_contact_no:String,val site_address:String,val site_business_starttime:String,val site_business_closingtime:String,val site_postcode:String,
                       val country_flag_path:String,val country_name:String,val status_id:String, val status:String,val fault_count:Int){

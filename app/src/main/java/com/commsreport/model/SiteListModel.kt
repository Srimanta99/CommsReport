...
data class SiteListModel(val status:Boolean,val message:String,val row :ArrayList<RowList>) {
    ...
    val site_email:String,val site_contact_no:String,val site_address:String,val site_business_starttime:String,val site_business_closingtime:String,val site_postcode:String,val status_id:String, val status:String){
